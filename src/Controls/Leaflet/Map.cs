...
using SmartLocate.Desktop.Admin.Controls.Leaflet.Events;
using SmartLocate.Desktop.Admin.Controls.Leaflet.JsInterop;
using SmartLocate.Desktop.Admin.Helpers;
...
public class Map
{
    ...
    public void AddLayer(Layer layer)
    {
        ...
        if (!_isInitialized)
        {
            throw new Exception("The map has not been yet initialized.");
        }
